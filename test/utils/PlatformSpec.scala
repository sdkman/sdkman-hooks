...
class PlatformSpec extends WordSpec with Matchers {
  "platform" should {
    "return some platform identifier when presented with a valid unnormalised client identifier" in {
      ...
      Platform("MINGW32_NT-6.1") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MINGW64_NT-6.1") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MINGW32_NT-6.1-WOW") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MINGW32_NT-6.2") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MINGW64_NT-6.3") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MINGW64_NT-10.0") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MSYS_NT-6.1") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MSYS_NT-6.3") shouldBe Some(Platform.Windows64Unsupported)
      Platform("MSYS_NT-10.0") shouldBe Some(Platform.Windows64Unsupported)
