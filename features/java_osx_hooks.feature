Feature: Java OSX Hooks
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | /hooks/post/java/8.0.202-librca/darwinx64   | Post Hook: osx-java-tarball |
      | /hooks/post/java/8.0.202-librca/darwinarm64 | Post Hook: osx-java-tarball |
  ...
  Scenario: The Liberica OSX post-install hook handles the flat tarball layout
