Feature: Java Windows Hooks
  ...
  Scenario: Install Oracle JDK on Cygwin Pre Hook
    When a hook is requested at /hooks/pre/java/8u161-oracle/cygwin
  ...
  Scenario: Install Oracle JDK on Mysys Pre Hook
    When a hook is requested at /hooks/pre/java/8u161-oracle/msys_nt-10.0
    Then a 200 status code is received
